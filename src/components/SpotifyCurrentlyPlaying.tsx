...
export default function SpotifyCurrentlyPlaying({
    ...
    const TrackInfo = (
        <Flex dir="row" justify="center" align="center" gap="2" ref={titleRef} className="whitespace-nowrap">
            <p className={`${titleSize} font-semibold leading-none text-gray-50`}>{track?.name}</p>
            <DotFilledIcon width={dotSize} height={dotSize} className="mx-2" />
            <p className={`${artistSize} font-normal leading-none text-gray-300`}>{artistNames}</p>
        </Flex>
    );
                    ...
                    {enableMarquee ? (
                        ...
                        >
                            <Flex dir="row" justify="center" align="center" gap="2" ref={titleRef}>
                                <p className={`${titleSize} font-semibold leading-none text-gray-50`}>
                                    {track.name}
                                </p>
                                <DotFilledIcon width={dotSize} height={dotSize} className="mx-2" />
                                <p className={`${artistSize} font-normal leading-none text-gray-300`}>
                                    {artistNames}
                                </p>
